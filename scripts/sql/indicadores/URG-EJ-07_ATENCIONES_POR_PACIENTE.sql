...
SELECT COUNT_BIG(*) AS atenciones, COUNT(DISTINCT codigo_cliente) AS pacientes_unicos,
  CAST(COUNT_BIG(*)*1.0/NULLIF(COUNT(DISTINCT codigo_cliente),0) AS decimal(18,2)) AS atenciones_por_paciente
FROM EventScope;
