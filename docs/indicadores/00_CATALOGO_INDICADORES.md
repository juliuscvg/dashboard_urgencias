...
|---|---|---|---|---|---|---|
| URG-EJ-01 | Ejecutivo | Atenciones | U-ING | COUNT(DISTINCT id_urgencia), no filas ni fechaate presente | IDENTIDAD VALIDADA; etiqueta ejecutiva aún candidata | URG-R01/R02 |
...
| URG-EJ-05 | Ejecutivo | Reingresos <72 h | U-RET | Eventos evaluables con retorno al mismo servicio y antecedente más reciente; tasa sobre evaluables | CONTRATO Y SQL VALIDADOS | URG-R06 |
| URG-EJ-06 | Ejecutivo | Pacientes únicos | Identificables U-POB | COUNT(DISTINCT codigo_cliente) | IDENTIDAD VALIDADA | URG-R01/R07 |
...
| URG-MOD-03 | Módulo | Reingresos | U-RET | <72 principal, <=48 secundario, bandas e historia previa | CONTRATO Y SQL VALIDADOS | URG-R06 |
